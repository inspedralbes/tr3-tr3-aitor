            ...
            <div class="flex-container">
                <div class="user-info-container">
                    <div class="input-container">
                        <label>Nom:</label>
                        <input type="text" name="nom" v-model="userData.nom" :readonly="!editing">
                    </div>
                    <div class="input-container">
                        <label>Cognoms:</label>
                        <input type="text" name="cognoms" v-model="userData.cognoms" :readonly="!editing">
                    </div>
                    <div class="campo">
                    ...
                    <div class="campo">
                        ...
                        <input type="password" id="password" :data-real-password="userData.password"
                            v-model="fakePassword" :readonly="!editarContraseña">
                    </div>
